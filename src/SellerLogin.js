...
function SellerLogin() {
  ...
  const handleSub=()=>{
    const postURL = "http://localhost:4000/seller/loginn" //Our previously set up route in the backend
    fetch(postURL, {
        method: 'POST',
        headers: {
    ...
    .then(()=>{
        ...
        alert('Sucessfully login as Seller!');
    })
  ...
  return (
    ...
    <div className="container-login">
      <form className="login-form-buyer" onSubmit={handleSubmit}>
        <h2 class="logoh2">Login as Seller</h2>
